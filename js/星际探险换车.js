<!-- 按键和车 -->
		// <script type="text/javascript">
			$('.text-text-text').find('.img1').eq(1).css('display', "none")
			...
			$('.yuan').click(function() {
				...
				$('.yuan').css({transform:'scale(1)'})
				$(this).css({transform:'scale(1.2)',border:"1px solid white"})
			})
		// </script>
		<!-- 上边和车 -->
		// <script type="text/javascript">
		...
		<!-- 第二个车和元 -->
		// <script type="text/javascript">
			$('.text-text-text').find('.img2').eq(1).css('display', "none")
			// $('.yuan').eq(0).css('bockground','#ffe400')
			$('.yuan2').click(function() {
				...
				$(this).css("background", "#ffe400")
				$('.yuan2').css({transform:'scale(1)'})
				$(this).css({transform:'scale(1.2)',border:"1px solid white"})
			})
		// </script>
		// <script type="text/javascript">
			$('.text-text-text').find('.img3').eq(1).css('display', "none")
			// $('.yuan').eq(0).css('bockground','#ffe400')
